...
def parse_args():
    ...
    # ===== dataset ===== #
    parser.add_argument("--dataset", nargs="?", default="last-fm", help="Choose a dataset:[last-fm,alibaba-ifashion,yelp2018,mind-f,amazon-book,MIND]")
    ...
    parser.add_argument("--node_dropout_rate", type=float, default=0.5, help="ratio of node dropout") #yelp-->0.75 last-fm-->0.3
